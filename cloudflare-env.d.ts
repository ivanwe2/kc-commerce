/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: bf3eb09576290086537c435b2834ceeb)
...
interface __BaseEnv_CloudflareEnv {
	...
	D1: D1Database;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SITE_URL: "https://kc-commerce-staging.workers.dev" | "https://kc-commerce.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_DEFAULT_LOCALE" | "NEXT_PUBLIC_SUPPORTED_LOCALES" | "NEXT_PUBLIC_CF_IMAGES" | "PAYLOAD_SECRET" | "PAYLOAD_LOG_LEVEL">> {}
}
