...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_unit" AS ENUM('piece', 'kg', 'g', 'l', 'ml', 'box', 'pack', 'set', 'pair', 'roll', 'm');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled', 'returned');
  CREATE TYPE "public"."enum_orders_shipping_method" AS ENUM('econt_office', 'econt_address', 'speedy_office', 'speedy_address');
  CREATE TYPE "public"."enum_orders_courier_service" AS ENUM('econt', 'speedy');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'customer');
  CREATE TYPE "public"."enum_redirects_to_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_forms_confirmation_type" AS ENUM('message', 'redirect');
  CREATE TYPE "public"."enum_payload_folders_folder_type" AS ENUM('media');
  CREATE TYPE "public"."enum_settings_supported_locales" AS ENUM('bg', 'en');
  CREATE TYPE "public"."enum_settings_social_links_platform" AS ENUM('facebook', 'instagram', 'twitter', 'linkedin', 'youtube', 'tiktok');
  CREATE TYPE "public"."enum_settings_default_locale" AS ENUM('bg', 'en');
  ...
  CREATE TABLE "products" (
  	...
  	"unit" "enum_products_unit" DEFAULT 'piece' NOT NULL,
  ...
  CREATE TABLE "orders" (
  	...
  	"customer_accepted_terms" boolean DEFAULT false NOT NULL,
  	"customer_marketing_consent" boolean DEFAULT false,
  	...
  	"shipping_address_country" varchar DEFAULT 'Bulgaria',
  	"shipping_address_notes" varchar,
  	"shipping_method" "enum_orders_shipping_method" NOT NULL,
  	"econt_office_code" varchar,
  	"speedy_office_code" varchar,
  	"subtotal" numeric NOT NULL,
  	"shipping_cost" numeric NOT NULL,
  	"total" numeric NOT NULL,
  	"tracking_number" varchar,
  	"courier_service" "enum_orders_courier_service",
  	"admin_notes" varchar,
  	"locale" varchar DEFAULT 'bg' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "settings_supported_locales" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_settings_supported_locales",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'KC Trading' NOT NULL,
  	"site_description" varchar,
  	"site_logo_id" integer NOT NULL,
  	"site_favicon_id" integer,
  	"default_locale" "enum_settings_default_locale" DEFAULT 'bg' NOT NULL,
  ...
  ALTER TABLE "settings_supported_locales" ADD CONSTRAINT "settings_supported_locales_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "settings" ADD CONSTRAINT "settings_site_favicon_id_media_id_fk" FOREIGN KEY ("site_favicon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "settings_supported_locales_order_idx" ON "settings_supported_locales" USING btree ("order");
  CREATE INDEX "settings_supported_locales_parent_idx" ON "settings_supported_locales" USING btree ("parent_id");
  ...
  CREATE INDEX "settings_site_favicon_idx" ON "settings" USING btree ("site_favicon_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "settings_supported_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_orders_courier_service";
  DROP TYPE "public"."enum_users_role";
  DROP TYPE "public"."enum_redirects_to_type";
  DROP TYPE "public"."enum_forms_confirmation_type";
  DROP TYPE "public"."enum_payload_folders_folder_type";
  DROP TYPE "public"."enum_settings_supported_locales";
